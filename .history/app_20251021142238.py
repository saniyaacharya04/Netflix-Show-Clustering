# ===============================================
# Netflix Intelligence Dashboard (Enhanced)
# ===============================================
import pandas as pd
import numpy as np
...
X = pd.concat([filtered_df[['release_year','duration_minutes','rating_encoded']], genre_dummies], axis=1)
...
filtered_df['PCA1'] = pca_components[:,0]
filtered_df['PCA2'] = pca_components[:,1]
...
if not genre_dummies.empty:
    genre_cluster = pd.concat([filtered_df['Cluster'], genre_dummies], axis=1).groupby('Cluster').sum()
