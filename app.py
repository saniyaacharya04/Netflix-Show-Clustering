...
mode = st.sidebar.selectbox("Clustering Mode", ["K-Means", "Hierarchical", "Comparison"])
...
if 'Cluster' in filtered_df.columns:
    ...
    st.download_button("Download CSV", filtered_df.to_csv(index=False), file_name="filtered_netflix.csv")
